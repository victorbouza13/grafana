...
var (
	...
	standardFeatureFlags = []FeatureFlag{
		...
		{
			Name:              "passTimeRangeToDashboardApi",
			Description:       "Enables the passing of time range to dashboards fetching in Grafana",
			FrontendOnly:      false,
			Stage:             FeatureStageExperimental,
			Owner:             grafanaDashboardsSquad,
			RequiresRestart:   false,
		...
		{
			Name:              "passFiltersToDashboardApi",
			Description:       "Enables the passing of filters to dashboards fetching in Grafana",
			FrontendOnly:      false,
			Stage:             FeatureStageExperimental,
			Owner:             grafanaDashboardsSquad,
			RequiresRestart:   false,
